...
class ComposerStaticInitWPFactoryCatalogHealthScannerForWooCommerce
{
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->classMap = ComposerStaticInitWPFactoryCatalogHealthScannerForWooCommerce::$classMap;
